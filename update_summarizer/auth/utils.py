...
<p><a style='text-decoration: none; color: #333; padding: 10px 15px; border: 1px solid #333; cursor: pointer;' href='{ url_for("auth.reset_password", id=id, token=token, _external=True) }' target='_blank'>Visit</a></p>
